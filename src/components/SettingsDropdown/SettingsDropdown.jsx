...
function SettingsDropdown({ dropdownOptions }) {
  ...
  return (
    <div className="w-fit">
      ...
      <div className="relative w-[40px]" ref={ref} >
        <div
        ...
        justifyContent={"justify-between"}
          ...
          ><img
              ...
              alt="option_icon"
            />
            <div className=" w-full">Blaise Deflo</div>
        ...
        {open && (
          <div className="absolute top-[40px] w-[200px] bg-white left-0 rounded flex flex-col ">
            <div className="p-2">
